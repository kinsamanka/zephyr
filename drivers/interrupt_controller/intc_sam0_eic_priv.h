...
#define MCLK_APBAMASK_EIC_BIT 9
#else
#define MCLK_APBAMASK_EIC_BIT 10
#endif
...
#define EIC_GCLK_IDX 4
#elif defined(CONFIG_SOC_SERIES_SAML21) || defined(CONFIG_SOC_SERIES_SAMR34) ||                    \
	defined(CONFIG_SOC_SERIES_SAMR35)
#define EIC_GCLK_IDX 3
#else
#define EIC_GCLK_IDX 2
#endif

#define GCLK_EIC_CLK_EN BIT(6)
...
#define MCLK_APBAMASK_OFFSET  0x18
#define MCLK_APBAMASK_EIC_BIT 6
...
#define GCLK_CLKCTRL_CLKEN_BIT 14
#define GCLK_EIC_CLK_EN        (CLKCTRL_ID_EIC | BIT(GCLK_CLKCTRL_CLKEN_BIT))
#define GCLK_EIC_CLK_OFFSET    0x02
